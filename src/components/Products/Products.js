      ...
      <React.Fragment>
            ...
            <Card  key={order.id} style={{
                  ...
                  <CardActionArea>
                        ...
                        <CardContent>
                             <Typography gutterBottom variant="h2" component="h2" className={classes.productname}>    
                                  {order.name}
                             </Typography>
        ...
        <Card>
           <CardContent>
            ...
            <CardActions>
                  ...
                  <Button size="small" color="primary" className={classes.productbutton} onClick={this.continueHandleOrder} 
                   >
                  Submit Order
                 </Button>
            </CardActions>
